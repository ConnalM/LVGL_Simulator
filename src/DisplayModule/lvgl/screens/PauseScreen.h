...
/**
 * @brief Screen shown when race is paused
 * 
 * Displays an alternating yellow light pattern across the light grid
 * to indicate the race is paused.
 */
...
public:
    ...
    void OnLeftButtonClick() override;  // RESUME
    void OnRightButtonClick() override; // STOP
